...
*NOTE:* Usually, there must be an alpha-renaming step to make sure every variable is unique, however, our CPS transformation has renamed each variable, so it's fine.
